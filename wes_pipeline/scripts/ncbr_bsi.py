...
def get_bsi_name(infield):
    fieldDict = {'CRIS Order #': 'sample.field_274',
                 ...
                 'Batch Sent Genome': 'sample.field_372',
                 'Batch Received Genome': 'sample.field_371',
                 'Genome ID': 'sample.field_373',
                 'Batch Sent Exome': 'sample.field_323',
                 'Batch Received Exome': 'sample.field_324',
                 ...
                 'Proband test':'subject_131.field_276',
                 ...
                 'Molecular Diagnosis at Intake': 'subject_131.field_198',
